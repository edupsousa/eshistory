...
MySqlFormatter.prototype.fileComplexityHeader = function () {
    return '';
};

MySqlFormatter.prototype.fileComplexityEntry = function (fileId, complexity) {
    return this.squel
            .insert()
            .into('file_metrics')
            .set('file_id', fileId)
            .set('loc', complexity.loc)
            .set('cyclomatic', complexity.cyclomatic)
            .set('functions', complexity.functionCount).toString() + ';\n';
};

MySqlFormatter.prototype.fileComplexityFooter = function () {
    return '';
}
