...
GitExplorer.prototype.getHistory = function() {
    var commits = [];
...
GitExplorer.prototype.getCommits = function(ids) {
    var self = this;
    var commits = [];
    var getDetails = function(i) {
        if (!ids[i]) return;

        return self.gitRepository.getCommit(ids[i])
...
GitExplorer.prototype.listCommitFiles = function(commitId) {
    ...
    return this.gitRepository.getCommit(commitId)
        .then(function(commit) {
