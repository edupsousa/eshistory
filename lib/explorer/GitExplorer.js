...
GitExplorer.prototype.createHistoryWalker = function(commitOid) {
...
GitExplorer.prototype.getCommitsAndAuthors = function(filter) {
    ...
    return this.gitRepository.getBranchCommit(filter.branch)
        .then(function(commit) {
            var walkHistory = self.createHistoryWalker(commit.id());
