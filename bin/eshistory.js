...
commander
    ...
    .option("--only-ref-commits", "Extract only commits pointed by references.")
...
if (commander.onlyRefCommits)
    config.commitFilter.onlyPointedByRef = true;
